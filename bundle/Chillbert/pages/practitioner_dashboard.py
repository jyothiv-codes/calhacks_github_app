...
if "user" not in st.session_state:
    ...
    st.error("You do not have access to this")

else:
    if 'ac' not in st.session_state and 'patient' in st.session_state:
        ac = AnalyseChat(st.session_state['patient'])
    ...
    with col2:
        ...
        st.text_input("Enter patient name",key='patient')
